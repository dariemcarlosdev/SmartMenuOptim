...
using SmartMenuOptim.Server.Features.AI.Models;
...
public class AIClientService : IAIClientService
{
    ...
    /// <summary>
    /// Initializes a new instance of AIClientService.
    /// </summary>
    public AIClientService(IHttpClientFactory httpClientFactory, ILogger<AIClientService> logger)
    {
