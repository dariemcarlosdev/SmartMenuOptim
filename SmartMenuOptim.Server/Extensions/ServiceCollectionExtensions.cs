...
public static class ServiceCollectionExtensions
{
    ...
    /// with the backend API (Supabase password grant + JIT provisioning), then issues this local cookie —
    /// the Supabase JWT itself is never stored here. See docs/06-Security/AUTHENTICATION_FRAMEWORK.md §4.
    /// </summary>
