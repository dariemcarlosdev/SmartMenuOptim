...
/// <summary>
/// Domain-level logic helper <strong>(domain-focused)</strong> extension methods for checking <see cref="AdminPermission"/> on <see cref="AdminUser"/>.
...
public static partial class AdminPermissionExtensions
{
    ...
    public static AdminPermission GetDefaultPermissionsForRole(this AdminRoleType role)
    {
        return role switch
        {
            AdminRoleType.SystemAdmin => AdminPermission.All,
            AdminRoleType.RestaurantOwner => AdminPermission.ManageRestaurants |
            ...
            AdminRoleType.RestaurantManager => AdminPermission.EditMenus |
                                 AdminPermission.ViewReports |
                                 AdminPermission.ManageStaff |
                                 AdminPermission.ManageOrders |
                                 AdminPermission.ViewCustomerData,
            AdminRoleType.RestaurantSupervisor => AdminPermission.ViewReports |
                                    AdminPermission.ViewCustomerData |
                                    AdminPermission.ManageOrders,
