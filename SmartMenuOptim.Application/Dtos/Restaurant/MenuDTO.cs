 ...
 * .NET Target: .NET 8
 * 
 * Purpose: Represents menu information for data transfer operations.
 * This DTO maps to the Menu aggregate in the Domain layer.
 * 
 * Multi-Tenant Considerations:
 * - RestaurantId links the menu to its parent restaurant (tenant)
 * - Contains only necessary data for client operations
 */

namespace SmartMenuOptim.Application.Dtos.Restaurant;
