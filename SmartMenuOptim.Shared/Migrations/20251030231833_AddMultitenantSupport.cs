        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModifiedByStaffId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminUsers_Phone_LastLogin",
                table: "AdminUsers",
                columns: new[] { "PhoneNumber", "LastLoginAt" });

            migrationBuilder.CreateIndex(
                name: "IX_AdminUsers_Role_Status",
                table: "AdminUsers",
                columns: new[] { "Role", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_Customers_Username_Active",
                table: "AdminUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessRules_RuleType_CreatedAt",
                table: "BusinessRules",
                columns: new[] { "RuleType", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_Email_Username_Unique",
                table: "Customers",
                columns: new[] { "Email", "Username" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_Phone_Verified",
                table: "Customers",
                columns: new[] { "PhoneNumber", "PhoneNumberConfirmed" });

            migrationBuilder.CreateIndex(
                name: "IX_Customers_Registered_Activity",
                table: "Customers",
                columns: new[] { "DateRegistered", "LastActivityDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Customers_Username_Active1",
                table: "Customers",
                columns: new[] { "Username", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_Username_Active2",
                table: "StaffMembers",
                columns: new[] { "Username", "IsActive" });
