...
namespace SmartMenuOptim.Shared.Data.Entities
{
    ...
    public class Restaurant
    {
        ...
        /// <summary>
        /// Date and time when the restaurant was created (UTC).
        /// </summary>
        //public DateTime CreatedAt { get; set; } = DateTime.UtcNow;

        /// <summary>
        /// Date and time when the restaurant was last updated (UTC).
        /// </summary>
        //public DateTime UpdatedAt { get; set; } = DateTime.UtcNow;

        /// <summary>
        /// Indicates if the restaurant is soft-deleted (for multi-tenant data retention).
        /// </summary>
