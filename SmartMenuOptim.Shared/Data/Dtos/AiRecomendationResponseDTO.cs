...
{
    /// <summary>
    /// DTO for transferring AI recommendation response data between layers and for CRUD operations in Blazor user interfaces.
    ...
    {
        public List<string> RecomendedDishes { get; set; } = new();
