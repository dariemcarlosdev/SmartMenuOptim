# Multi-Tenancy Architecture in SmartMenuOptimizer

## Overview

SmartMenuOptimizer implements a hierarchical multi-tenant architecture where restaurants serve as the primary tenants, and admin users can manage multiple restaurants. This document outlines the implementation details and patterns used to achieve secure tenant isolation.
